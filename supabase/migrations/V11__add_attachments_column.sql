-- V11: Add attachments column to public.messages and update send_mail_transaction RPC

-- 1. Ensure attachments column exists on public.messages table
...
BEGIN
  ...
  -- 3. Resolve & Validate ALL Recipients
  ...
  -- 4. Create Master Message with attachments JSONB
